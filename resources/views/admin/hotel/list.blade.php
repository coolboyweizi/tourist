    ...
    <blockquote class="layui-elem-quote">
        <div class="layui-btn-group ">
            ...
            @can('zixun.article.create')
                <a class="layui-btn layui-btn-sm" href="{{ route('admin.hotel.create') }}">添 加</a>
            @endcan
        </div>
        <form class="layui-form" style="float:right;">
            <div class="layui-form-item" style="margin:0;">
                <input type="hidden" name="app" value="hotel" />
                    ...
                    $(this).children('td:last-child').children('input').each(function () {
                        ...
                        $that.on('click', function () {
                            switch (action) {
                                ...
                                case 'edit':
                                    window.location.href= base_url + 'admin/hotel/'+id+'/edit';
                                    break;

                                case 'price':
                                    window.location.href= base_url + 'admin/hotelPrice/view/'+id;
                                    break;
