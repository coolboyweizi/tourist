        ...
        <form class="layui-form" style="float:right;">
            <div class="layui-form-item" style="margin:0;">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" name="app" value="notification" />
                    ...
                    format      : function (val,obj) {
                        ...
                        if(obj.status > 0){
                            return  '<input type="button" value="已通过" data-action="approved" data-id="' + val + '" class="layui-btn layui-btn-disabled" /> ' +
                                ...
                                return  '<input type="button" value="已通过" data-action="approved1" data-id="' + val + '" class="layui-btn layui-btn-mini" /> ' +
                                    '<input type="button" value="未通过" data-action="notPass2" data-id="' + val + '" class="layui-btn layui-btn-mini" /> ' +
                                '<input type="button" value="删除" data-action="del" data-id="' + val + '" class="layui-btn layui-btn-mini layui-btn-danger" />';
                            }
