    ...
    <blockquote class="layui-elem-quote">
        <div class="layui-btn-group ">
            ...
            @can('zixun.article.create')
                <a class="layui-btn layui-btn-sm" href="{{ route('admin.hotelPrice.create',['id'=> $app_id]) }}">添 加</a>
            @endcan
        </div>
        <form class="layui-form" style="float:right;">
            <div class="layui-form-item" style="margin:0;">
                <label class="layui-form-label">名称</label>
                <input type="hidden" name="app" value="hotelPrice"/>
                <div class="layui-input-inline">
                    <input type="text" name="keywords" placeholder="支持模糊查询.." autocomplete="off" class="layui-input">
                </div>
            ...
            columns: [{                          //配置数据列
                ...
                format: function (id, obj) {
                    ...
                    format: function (id, obj) {
                        ...
                        var html = "<img style='width: 50px; height: 50px;' src='"+obj.thumbs+"' />";
                        return html;
                    }
                },{
                    fieldName: '价格',
                ...
                $elem.children('tr').each(function () {
                    $(this).children('td:last-child').children('input').each(function () {
                        ...
                        $that.on('click', function () {
                            switch (action) {
                                case 'edit':
                                    window.location.href= base_url + 'admin/hotelPrice/'+id+'/edit';
                                    break;
