        ...
        <div class="layui-col-sm6 layui-col-md3">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body layuiadmin-card-list">
                    ...
                    <p class="layuiadmin-big-font">{{ $userNew }}</p>
        ...
        <div class="layui-col-sm6 layui-col-md3">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body layuiadmin-card-list">
                    ...
                    <p class="layuiadmin-big-font">{{ $monSystem }}</p>

                    <p>

                        总收入

                        <span class="layuiadmin-span-color">{{ $allSystem }} <i class="layui-inline layui-icon layui-icon-dollar"></i></span>
        ...
        <div class="layui-col-sm6 layui-col-md3">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body layuiadmin-card-list">
                    ...
                    <p class="layuiadmin-big-font">{{ $userLive }}</p>
