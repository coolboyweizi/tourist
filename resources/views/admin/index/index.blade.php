                                ...
                                <div carousel-item>
                                    ...
                                    <ul class="layui-row layui-col-space10">
                                        ...
                                        <li class="layui-col-xs3">
                                            ...
                                            <a lay-href="{{ route('admin.withdraw.view') }}">
                                        ...
                                        <li class="layui-col-xs3">
                                            ...
                                            <a lay-href="{{ route('admin.comment.view') }}">
                                    ...
                                    <ul class="layui-row layui-col-space10">
                                        ...
                                        <li class="layui-col-xs6">
                                            ...
                                            <a lay-href="app/forum/list.html" class="layadmin-backlog-body">
                                                ...
                                                <p><cite>{{ $withdraw->dealing()->count() }}</cite></p>
                                        ...
                                        <li class="layui-col-xs6">
                                            ...
                                            <a href="javascript:;" onclick="layer.tips('不跳转', this, {tips: 3});" class="layadmin-backlog-body">
                                                ...
                                                <p><cite>{{ $order->payed()->count()  }}</cite></p>
...
@section('script')
    <script>
        var fluxValue = {!! \GuzzleHttp\json_encode($flux->values()->all()) !!},
            fluxTime  = {!! \GuzzleHttp\json_encode($flux->keys()->all()) !!},
            userTime = {!! \GuzzleHttp\json_encode($user->weekReg()->keys()->all()) !!},
            userNumb = {!! \GuzzleHttp\json_encode($user->weekReg()->values()->all()) !!}
