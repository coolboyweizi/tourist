            ...
            [
                ...
                'child' => [
                    [
                        'name' => 'project.view',
                        'display_name' => '景区项目',
                        'route' => 'admin.project.view',
                        'icon_id' => '124',
                    ],
                    [
                        'name' => 'hotel.view',
                        'display_name' => '酒店列表',
                        'route' => 'admin.hotel.view',
                        'icon_id' => '124',
                    ],
                    [
                        'name' => 'travel.view',
                        'display_name' => '直通车',
                        'route' => 'admin.travel.view',
                        'icon_id' => '124',
                    ],
                ]
            ],
            ...
            [
                ...
                'child' => [
                    [
                        'name' => 'talent.group',
                        'display_name' => '达人用户组',
                        'route' => 'admin.talentGroup.view',
                        'icon_id' => '124',
                    ],
                    [
                        'name' => 'talent.user',
                        'display_name' => '达人用户',
                        'route' => 'admin.talentUser.view',
                        'icon_id' => '124',
                    ],
                    [
                        'name' => 'talent.view',
                        'display_name' => '达人线路',
                        'route' => 'admin.talent.view',
                        'icon_id' => '124',
                    ],
                ]
            ],
